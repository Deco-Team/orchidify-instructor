...
const AssignmentDetailInformation = ({
  classId,
  assignment
}: {
  assignment: AssignmentDto & { minDeadline: string; maxDeadline: string }
  classId: string
}) => {
  ...
  return (
    <Paper sx={{ width: '100%', marginTop: '1.25rem', padding: '1.5rem' }}>
      ...
      <Box>
        <UpdateAssignmentDeadlineForm classId={classId} assignment={assignment} />
      </Box>
    </Paper>
  )
}
